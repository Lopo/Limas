Ext.define('Limas.PartMeasurementUnitGrid', {
	...
	initComponent: function () {
		...
		this.getSelectionModel().on('deselect', Ext.bind(function (rsm, r, i) {
			this.defaultButton.disable();
		}, this));
		this.getSelectionModel().on('select', Ext.bind(function (rsm, r, i) {
	...
	onDefaultClick: function () {
		let r = this.getSelectionModel().getLastSelected();
