 ...
 *
 * Example: If you have set your dataIndex to an object like "distributor", and you need the object in-place to perform
 * editing on it, for example, using a ComboBox, you probably wish to display another value than the object itself (like
 * the distributor's name).
 */
Ext.define('Limas.Components.Grid.Renderers.ObjectFieldRenderer', {
	...
	renderer: function (value, metaData, record, rowIndex, colIndex, store, view, renderObj) {
		let displayField = renderObj.getRendererConfigItem(renderObj, 'displayField', false);
