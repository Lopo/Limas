Ext.define('Limas.Importer.ImporterManyToOneConfiguration', {
	...
	initComponent: function () {
		...
		let importBehaviourChangeListeners = [
			'#alwaysSetTo',
			'#matchData',
			'#dontUpdateData',
			'#updateData',
	...
	setImporterConfig: function (config) {
		...
		this.down('#importFieldMatcherGrid').setImporterConfig(this.importerConfig.hasOwnProperty('matchers') ? this.importerConfig.matchers : {});
