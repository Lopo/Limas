Ext.define('Limas.StorageLocationMultiAddDialog', {
	...
	initComponent: function () {
		/**
		 * The prefix represents the first part of the storage location name, e.g. "A" for storage locations "A0001"
		 */
	...
	getStorageLocations: function () {
		...
		for (let i = this.storageLocationStart.getValue(); i < this.storageLocationEnd.getValue() + 1; i++) {
			if (!this.storageLocationZeroPrefix.getValue()) {
				// No padding wanted
