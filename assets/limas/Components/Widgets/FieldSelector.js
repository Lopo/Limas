Ext.define('Limas.Components.Widgets.FieldSelector', {
	...
	treeMaker: function (node, model, prefix, callback, originalVisitedModels) {
		let fields = model.getFields(),
			checked, newNode, i, j, childNode,
			skipSubModel = false, associationAlreadyProcessed,
			visitedModels = originalVisitedModels.slice(0);
