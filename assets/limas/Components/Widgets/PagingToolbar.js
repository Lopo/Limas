Ext.define('Limas.PagingToolbar', {
	...
	getPagingItems: function () {
		...
		items.push(Ext.create('Limas.Exporter.GridExporterButton', {
			itemId: 'export',
			tooltip: i18n('Export'),
		...
		items.push(Ext.create('Limas.Importer.GridImporterButton', {
			itemId: 'import',
			tooltip: i18n('Import'),
		...
		items.push(Ext.create('Limas.Components.Grid.GridPresetButton', {
			grid: this.grid
		}));
