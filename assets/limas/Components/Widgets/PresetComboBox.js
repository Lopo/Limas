Ext.define('Limas.PresetCombobox', {
	...
	savePreset: function (presetName) {
		let presetRecord = this.getSelectedRecord();
	...
	/**
	 * Creates a blank preset. Sets the selection to null and fires selectPreset with blankConfiguration.
	 */
