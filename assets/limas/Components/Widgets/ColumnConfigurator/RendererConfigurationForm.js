Ext.define('Limas.Components.Widgets.ColumnConfigurator.RendererConfigurationForm', {
	...
	initComponent: function () {
		let renderer = Limas.Components.Grid.Renderers.RendererRegistry.lookupRenderer(this.renderer);
	...
	createFormConfig: function (renderer) {
		let config, field, fields = [], useDescriptionElemement;

		for (let configIterator in renderer.rendererConfigs) {
