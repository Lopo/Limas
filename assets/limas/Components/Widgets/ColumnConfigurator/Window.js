Ext.define('Limas.Components.Widgets.ColumnConfigurator.Window', {
	...
	initComponent: function () {
		this.columnConfiguratorPanel = Ext.create('Limas.Components.Widgets.ColumnConfigurator.Panel', {
			grid: this.grid
		});
