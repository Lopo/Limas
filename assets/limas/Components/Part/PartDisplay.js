Ext.define('Limas.PartDisplay', {
	...
	initComponent: function () {
		...
		this.imageDisplay = Ext.create('Limas.PartImageDisplay', {
			title: i18n('Images'),
		});

		this.infoGrid = Ext.create('Limas.Components.Part.PartInfoGrid', {
			title: {
				height: 'auto',
			...
			columns: [
				{
					...
					renderer: function (v, m, rec) {
						return Limas.PartManager.formatParameter(rec);
					},
					flex: 1
				}
			]
	...
	addPartStockPrompt: function () {
		new Limas.PartStockWindow({partUnitName: this.record.get('partUnitName')}).addStock(this.addStockHandler, this);
	},
	/**
	...
	removePartStockPrompt: function () {
		new Limas.PartStockWindow({partUnitName: this.record.get('partUnitName')}).removeStock(this.removeStockHandler, this);
	},
	/**
