 ...
 *
 * The barcode manager decides which action(s) will be called based upon the configuration done in the system preferences
 */
Ext.define('Limas.BarcodeScanner.Action', {
	statics: {
		/**
	 ...
	 */
	execute: function () {
		console.error('The execute function of any Limas.BarcodeScanner.Action subclass must be overridden!');
	}
});
