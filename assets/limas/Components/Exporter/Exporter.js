Ext.define('Limas.Exporter.Exporter', {
	extend: 'Limas.Widgets.EntityQueryPanel',
	...
	onExportSuccessful: function (options, success, response) {
		let blob = new Blob([response.responseText], {type: this.down('#formatSelector').getValue().get('mimetype')});
