 ...
 */
Ext.define('Limas.form.field.SearchField', {
	extend: 'Ext.form.field.Text',
	alias: 'widget.limas-searchfield',
	...
	startSearch: function () {
		...
		if (this.searchFieldSystemPreference !== null) {
			let fields = Limas.getApplication().getSystemPreference(this.searchFieldSystemPreference, this.searchFieldSystemPreferenceDefaults);
