	...
	extends AbstractMigration
{
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('CREATE TABLE FootprintAttachment (id INT AUTO_INCREMENT NOT NULL, footprint_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_7B7388A151364C98 (footprint_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		$this->addSql('CREATE TABLE FootprintCategory (id INT AUTO_INCREMENT NOT NULL, root_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, name VARCHAR(128) NOT NULL, description LONGTEXT DEFAULT NULL, categoryPath LONGTEXT DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, lvl INT NOT NULL, INDEX IDX_C026BA6A79066886 (root_id), INDEX IDX_C026BA6A727ACA70 (parent_id), INDEX IDX_C026BA6ADA439252 (lft), INDEX IDX_C026BA6AD5E02D69 (rgt), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		$this->addSql('CREATE TABLE FootprintImage (id INT AUTO_INCREMENT NOT NULL, footprint_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, UNIQUE INDEX UNIQ_3B22699151364C98 (footprint_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('CREATE TABLE ManufacturerICLogo (id INT AUTO_INCREMENT NOT NULL, manufacturer_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_3F1EF213A23B42D (manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('CREATE TABLE PartAttachment (id INT AUTO_INCREMENT NOT NULL, part_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, isImage TINYINT(1) DEFAULT NULL, INDEX IDX_76D73D864CE34BEC (part_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		$this->addSql('CREATE TABLE PartCategory (id INT AUTO_INCREMENT NOT NULL, root_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, name VARCHAR(128) NOT NULL, description LONGTEXT DEFAULT NULL, categoryPath LONGTEXT DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, lvl INT NOT NULL, INDEX IDX_131FB61979066886 (root_id), INDEX IDX_131FB619727ACA70 (parent_id), INDEX IDX_131FB619DA439252 (lft), INDEX IDX_131FB619D5E02D69 (rgt), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('CREATE TABLE ProjectAttachment (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, INDEX IDX_44010C5B166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('CREATE TABLE StorageLocationCategory (id INT AUTO_INCREMENT NOT NULL, root_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, name VARCHAR(128) NOT NULL, description LONGTEXT DEFAULT NULL, categoryPath LONGTEXT DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, lvl INT NOT NULL, INDEX IDX_3E39FA4779066886 (root_id), INDEX IDX_3E39FA47727ACA70 (parent_id), INDEX IDX_3E39FA47DA439252 (lft), INDEX IDX_3E39FA47D5E02D69 (rgt), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		$this->addSql('CREATE TABLE StorageLocationImage (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, storageLocation_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_666717F073CD58AF (storageLocation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('CREATE TABLE TempImage (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		$this->addSql('CREATE TABLE TempUploadedFile (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) DEFAULT NULL, mimetype VARCHAR(255) NOT NULL, size INT NOT NULL, description LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('ALTER TABLE FootprintCategory ADD CONSTRAINT FK_C026BA6A79066886 FOREIGN KEY (root_id) REFERENCES FootprintCategory (id)');
		...
		$this->addSql('ALTER TABLE PartCategory ADD CONSTRAINT FK_131FB61979066886 FOREIGN KEY (root_id) REFERENCES PartCategory (id)');
		...
		$this->addSql('ALTER TABLE StorageLocationCategory ADD CONSTRAINT FK_3E39FA4779066886 FOREIGN KEY (root_id) REFERENCES StorageLocationCategory (id)');
		...
		$this->addSql('ALTER TABLE unit_siprefix ADD CONSTRAINT FK_E9E8D93F8BD700D FOREIGN KEY (unit_id) REFERENCES Unit (id)');
		$this->addSql('ALTER TABLE unit_siprefix ADD CONSTRAINT FK_E9E8D939BE9F1F4 FOREIGN KEY (siprefix_id) REFERENCES SiPrefix (id)');
	...
	public function postUp(Schema $schema): void
	{
		...
		$manager->persist($root->setRoot($root));
